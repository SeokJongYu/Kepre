...
$(document).on 'turbolinks:load', ->
    return unless page.controller() == 'kbio_mhcii_result' && page.action() == 'plot2'
    ...
    args = 
        root: '#KBIO_MHCII_chart'
        'network_data': $('#KBIO_MHCII_chart').data('results')
        'about': about_string
    ...
    resize_container = (args) ->
        ...
        screen_width = document.getElementById('KBIO_MHCII_chart').offsetWidth
        screen_height = document.getElementById('KBIO_MHCII_chart').offsetHeight
