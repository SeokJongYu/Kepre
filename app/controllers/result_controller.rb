class ResultController < ApplicationController
  ...
  def summary
    if params[:tool_type] == "KBIO-MHC-I"
      redirect_to kbio_mhci_result_summary_path( :result_id => params[:result_id], :analysis_id => params[:analysis_id] )
    elsif params[:tool_type] == "KBIO-MHC-II"
      redirect_to kbio_mhcii_result_summary_path( :result_id => params[:result_id], :analysis_id => params[:analysis_id] )
    end
  end
